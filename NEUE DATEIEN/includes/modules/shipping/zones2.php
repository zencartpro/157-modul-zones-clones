 ...
 * @version $Id: zones2.php 2023-11-19 09:27:16Z webchills $
 */
/*
...
// shipping adjustment
    ...
    $this->quotes = array(
      ...
      if (strpos(MODULE_SHIPPING_ZONES2_SKIPPED, $dest_country) !== false) {
    ...
    function remove() {
      global $db;
      $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key like 'MODULE\_SHIPPING\_ZONES2\_%'");
      $db->Execute("delete from " . TABLE_CONFIGURATION_LANGUAGE . " where configuration_key like 'MODULE\_SHIPPING\_ZONES2\_%'");
    }
